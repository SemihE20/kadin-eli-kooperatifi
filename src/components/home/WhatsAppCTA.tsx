...
export default function WhatsAppCTA() {
  const whatsappLink = generateWhatsAppLink(
    "Merhaba! Gözler Kadıneli Kooperatifi ürünleri hakkında bilgi almak istiyorum. 🌿"
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl gradient-hero p-8 sm:p-12">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
            {/* WhatsApp Icon */}
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-green-500 rounded-2xl flex items-center justify-center shrink-0 shadow-lg">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-green-500 text-white text-sm font-semibold rounded-xl hover:bg-green-600 transition-all duration-200 shadow-lg hover:shadow-xl shrink-0"
            >
